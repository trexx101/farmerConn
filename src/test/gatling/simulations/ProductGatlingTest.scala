...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "productName":"SAMPLE_TEXT", "productDescription":"SAMPLE_TEXT", "sku":"SAMPLE_TEXT", "quantityPerUnit":"0", "discount":null, "minOrder":"0", "picture":null, "unitPrice":null}""")).asJSON
            .check(status.is(201))
